...
include_graphics(here("4_output_figures", "hero_figure.pdf"))
...
snake_case is Style Guide Approved), indentations and spaces, object names, etc. See the link below to the tidyverse style guide.
...
tl;dr: The names of your files should be 
1. Machine readable 
2. Human readable 
2. Sortable 
